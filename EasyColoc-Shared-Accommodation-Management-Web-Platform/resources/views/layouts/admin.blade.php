...
<body class="bg-gray-50 text-gray-900 antialiased flex h-screen overflow-hidden selection:bg-indigo-500 selection:text-white">
    ...
    <aside class="w-64 bg-slate-900 text-slate-300 flex flex-col transition-all duration-300 z-20 shadow-xl">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1">
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 bg-indigo-500/10 text-indigo-400 rounded-lg font-medium transition-colors">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
                Dashboard
            </a>

            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium hover:bg-slate-800 hover:text-white transition-colors">
        ...
        <div class="p-4 border-t border-slate-800 bg-slate-950/30">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-indigo-500 border-2 border-slate-800 flex items-center justify-center text-white font-bold text-sm">GA</div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-bold text-white truncate">Global Admin</p>
                    <p class="text-xs text-slate-400 truncate">admin@roomiesync.com</p>
                </div>
