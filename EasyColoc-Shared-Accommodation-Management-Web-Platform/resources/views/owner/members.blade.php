  ...
  <div class="md:hidden border-t border-gray-200 bg-white">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-3xl shadow-lg p-1 overflow-hidden relative">
            ...
            <div class="bg-white rounded-[1.4rem] p-6 sm:p-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex-1">
                    ...
                    <p class="text-gray-500 text-sm mt-1">Send this unique link or token to a roommate. They will be added to this home automatically when they register.</p>
                </div>
                
                <div class="w-full md:w-auto flex-shrink-0 bg-gray-50 p-4 rounded-2xl border border-gray-200 shadow-inner">
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Invite Token</label>
                    <div class="flex items-center gap-2">
                        <code class="px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-lg font-mono font-bold text-indigo-600 shadow-sm w-full md:w-48 text-center tracking-widest">
                            X79-B2Q
                        </code>
                        <button class="p-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" title="Copy to clipboard">
                    ...
                    <button class="w-full mt-3 py-2 text-sm font-semibold text-indigo-600 hover:text-indigo-800 transition-colors text-center">
                        Or send via Email
                    </button>
                </div>
            </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <ul class="divide-y divide-gray-100">
                <li class="p-6 flex flex-col sm:flex-row sm:items-center gap-4 hover:bg-gray-50/50 transition-colors">
                    <div class="relative">
                        <div class="w-14 h-14 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold text-xl shadow-md border-2 border-white">Y</div>
                        <div class="absolute -bottom-1 -right-1 w-5 h-5 bg-green-500 border-2 border-white rounded-full"></div>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            <p class="text-lg font-bold text-gray-900">You <span class="text-gray-400 font-normal text-sm">(Owner)</span></p>
                            <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-indigo-100 text-indigo-700 uppercase tracking-wider">Admin</span>
                        </div>
                    ...
                    <div class="flex items-center gap-6">
                        <div class="text-right">
                            ...
                            <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-sm font-bold bg-green-100 text-green-700">
                ...
                <li class="p-6 flex flex-col sm:flex-row sm:items-center gap-4 hover:bg-gray-50/50 transition-colors">
                    <div class="relative">
                        <div class="w-14 h-14 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold text-xl shadow-sm border-2 border-white">SJ</div>
                        <div class="absolute -bottom-1 -right-1 w-5 h-5 bg-green-500 border-2 border-white rounded-full"></div>
                    </div>
                    <div class="flex-1">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="text-right hidden sm:block">
                            <p class="text-xs text-gray-500 uppercase font-semibold mb-1">Reputation</p>
                            <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-sm font-bold bg-green-100 text-green-700">+2</span>
                        </div>
                        <button class="w-full sm:w-24 px-4 py-2 border border-red-200 text-red-600 bg-red-50 hover:bg-red-100 hover:border-red-300 rounded-xl text-sm font-bold transition-colors shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                            Remove
                        </button>
                    </div>
                </li>
                ...
                <li class="p-6 flex flex-col sm:flex-row sm:items-center gap-4 hover:bg-gray-50/50 transition-colors">
                    <div class="relative">
                        <div class="w-14 h-14 rounded-full bg-orange-100 flex items-center justify-center text-orange-700 font-bold text-xl shadow-sm border-2 border-white">MK</div>
                        <div class="absolute -bottom-1 -right-1 w-5 h-5 bg-green-500 border-2 border-white rounded-full"></div>
                    </div>
                    <div class="flex-1">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="text-right hidden sm:block">
                            <p class="text-xs text-gray-500 uppercase font-semibold mb-1">Reputation</p>
                            <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-sm font-bold bg-gray-100 text-gray-600">0</span>
                        </div>
                        <button class="w-full sm:w-24 px-4 py-2 border border-red-200 text-red-600 bg-red-50 hover:bg-red-100 hover:border-red-300 rounded-xl text-sm font-bold transition-colors shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                            Remove
                        </button>
