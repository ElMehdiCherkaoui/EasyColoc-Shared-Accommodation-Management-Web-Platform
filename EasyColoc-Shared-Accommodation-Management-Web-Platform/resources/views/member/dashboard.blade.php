...
<head>
    ...
    <title>Member Dashboard - RoomieSync</title>
...
<body class="bg-gray-50 text-gray-900 antialiased selection:bg-indigo-500 selection:text-white pb-12">
    ...
    <header class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-1">Welcome back, Alex. Here’s what matters for you today.</p>
            </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                <p class="text-sm font-medium text-gray-500 mb-1">This Month Spending</p>
                <h2 class="text-4xl font-extrabold text-gray-900">$410.50</h2>
                <p class="text-sm text-gray-500 mt-2">Your paid total</p>
            </div>

            <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                <p class="text-sm font-medium text-gray-500 mb-1">Reputation</p>
                <h2 class="text-4xl font-extrabold text-green-600">+2</h2>
                <p class="text-sm text-gray-500 mt-2">Good standing</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-200 bg-gray-50/50 flex justify-between items-center">
                <h3 class="text-lg font-bold text-gray-900">Action Needed</h3>
                <span class="bg-red-100 text-red-700 py-1 px-3 rounded-full text-xs font-semibold">Pending</span>
            </div>
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="p-5 rounded-2xl border border-gray-100 bg-white shadow-sm">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            <p class="text-sm font-semibold text-gray-900">You owe Mike</p>
                            <p class="text-xs text-gray-500 mt-1">For overall balance</p>
                        </div>
                        <span class="text-xl font-bold text-red-600">$35.00</span>
                    </div>

                    <div class="mt-4 flex items-center gap-3">
                        <button
                            class="px-4 py-2 bg-indigo-600 text-white text-sm font-bold rounded-xl hover:bg-indigo-700 shadow-sm transition-colors">
                            Mark as Paid
                        </button>
                        <button
                            class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-bold rounded-xl hover:bg-gray-50 transition-colors">
                            See Details
                        </button>
                    </div>
                </div>
                ...
                <div class="p-5 rounded-2xl border border-gray-100 bg-white shadow-sm">
                    <p class="text-sm font-semibold text-gray-900">Next suggestion</p>
                    <p class="text-sm text-gray-500 mt-2">
                        Add expenses as soon as you pay to keep balances accurate.
                    </p>
                    <div class="mt-4">
                        <a href="#"
                            class="inline-flex items-center gap-2 text-indigo-600 font-bold hover:text-indigo-800">
                            Log an expense
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-gray-100">
                <div class="p-6 flex items-center justify-between">
                    <div>
                        <p class="font-bold text-gray-900">Groceries</p>
                        <p class="text-sm text-gray-500">Feb 18, 2026 · Paid by You</p>
                    </div>
                    <span class="font-extrabold text-gray-900">$120.50</span>
                </div>
                <div class="p-6 flex items-center justify-between">
                    <div>
                        <p class="font-bold text-gray-900">Internet Bill</p>
                        <p class="text-sm text-gray-500">Feb 21, 2026 · Paid by Sarah</p>
                    </div>
                    <span class="font-extrabold text-gray-900">$60.00</span>
                </div>
            </div>
        </div>
